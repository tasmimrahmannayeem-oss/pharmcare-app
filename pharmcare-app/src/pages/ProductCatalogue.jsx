        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 99999, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <label htmlFor="rx-upload" style={{ border: prescriptionFile ? '2px solid #006c49' : '2px dashed #ddd', borderRadius: 12, padding: prescriptionFile ? 20 : 36, background: '#f8f9fa', cursor: 'pointer', display: 'block' }}>
                {prescriptionFile ? (
